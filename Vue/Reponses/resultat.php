...
<html>
    ...
    <body>
        ...
        <?php } else { ?>
            <div class="container">
                <form action="Reponses/exportCSV" method="POST">
                    <h2 class="text-center">Liste de vos réponses</h2><br/>
                    <button class="btn btn-info" title="Exporter" type="submit">Exporter</button><br/>

                    <input type="hidden" value="<?= $this->nettoyer($users->getObjectId()) ?>" name="id" >
